    ...
    return function (t) {
        ...
        t.exports = function (t, e, r, _, y, v, m) {
            ...
            if (D && (b = h(D.call(new t))) !== Object.prototype && (l(b, x, !0), i || a(b, c) || o(b, c, d)), P && C && "values" !== C.name && (T = !0, k = function () {
                    return C.call(this)
                }), i && !m || !f && !T && M[c] || o(M, c, k), p[e] = k, p[x] = d, y)
                if (g = {
                        values: P ? k : S("values"),
                        keys: v ? k : S("keys"),
                        entries: O
        ...
        var i = r(13),
            ...
            W = function (t, e, r) {
                return t === U && W(X, e, r), g(t), e = b(e, !0), g(r), s(Y, e) ? (r.enumerable ? (s(t, R) && t[R][e] && (t[R][e] = !1), r = x(r, {
                    enumerable: S(0, !1)
                })) : (s(t, R) || O(t, R, S(1, {})), t[R][e] = !0), z(t, e, r)) : O(t, e, r)
            },
            G = function (t, e) {
                g(t);
        ...
        t.exports = function (t) {
            var e = i(t),
                r = s.f;
            if (r)
                for (var o, a = r(t), p = n.f, u = 0; a.length > u;) p.call(t, o = a[u++]) && e.push(o);
            return e
        }
    }, function (t, e) {
        ...
        r = function () {
            ...
            return t.prototype.NS = "http://www.w3.org/2000/svg", t.prototype.logBadgeCss = "background:#3A0839;color:#FF512F;border-radius:5px; padding: 1px 5px 2px; border: 1px solid #FF512F;", t.prototype.shortColors = {
                ...
                if (r = t.length, i = e.length, r > i)
                    for (p = r - i, h = e.length, n = o = 0, u = p; 0 <= u ? o < u : o > u; n = 0 <= u ? ++o : --o) s = n + h, e.push(this.parseUnit("0" + t[s].unit));
                else if (i > r)
                    for (p = i - r, h = t.length, n = a = 0, l = p; 0 <= l ? a < l : a > l; n = 0 <= l ? ++a : --a) s = n + h, t.push(this.parseUnit("0" + e[s].unit));
                return [t, e]
                ...
                if (e = this.cloneObj(e), null != (n = e.easing) && (n = mojs.easing.parseEasing(n)), delete e.easing, null != (i = e.curve) && (i = mojs.easing.parseEasing(i)), delete e.curve, c = Object.keys(e)[0], o = e[c], s = {
                        start: c
        ...
        var n = new(function () {
            ...
            return t.prototype._vars = function () {
                ...
                var e = "number" == typeof t ? t : this.tweens.indexOf(t); - 1 !== e && (t = this.tweens[e]) && (t._isRunning = !1, this.tweens.splice(e, 1), t._onTweenerRemove())
        ...
        (function (e) {
            ...
            s = r(71), i = new(function () {
                ...
                return t.prototype.vars = function () {
                    ...
                    for (v = m = 0; m < 4; v = ++m)
                        if ("number" != typeof (u = arguments[v]) || isNaN(u) || !isFinite(u)) return this.error("Bezier function expects 4 arguments");
                    return t < 0 || t > 1 || i < 0 || i > 1 ? this.error("Bezier x values should be > 0 and < 1") : (4, .001, 1e-7, 10, 11, .1, d = n.call(e, "Float32Array") >= 0, o = function (t, e) {
                        ...
                        for (o = void 0, n = void 0, v = 0;;)
                            if (n = r + (s - r) / 2, (o = h(n, t, i) - e) > 0 ? s = n : r = n, !(Math.abs(o) > 1e-7 && ++v < 10)) break;
                        return n
                    }, y = function (e) {
                        var r, s, n, o, a, p;
        ...
        s = r(71), i = function () {
            ...
            return t.prototype._vars = function () {
                ...
                var r, i, s, n, o, a, p, u;
                if (null == e && (e = 0), t = t.trim(), o = /(-|\+)?((\d+(\.(\d|\e(-|\+)?)+)?)|(\.?(\d|\e|(\-|\+))+))/gim, a = this._getSegmentPairs(t.match(o)), s = a[a.length - 1], u = s[0], Number(u) !== e)
                    for (t = "", s[0] = e, r = i = 0, n = a.length; i < n; r = ++i) p = a[r], t += "" + (0 === r ? "" : " ") + p[0] + "," + p[1];
                return t
        ...
        i = null, o = function (t) {
            ...
            var t;
            return (t = 1 <= arguments.length ? p.call(arguments, 0) : []).length > 1 ? t = t.sort(a) : t[0].value = o(t[0]),
                function (e) {
                    var r, i;
        ...
        var s = i(r(111)),
            ...
            l = function (t) {
                ...
                return (0, a.default)(e, t), e.prototype.add = function () {
                    ...
                    t.timeline instanceof e && (t = t.timeline), t.tween instanceof u.default && (t = t.tween), null != r && t._setProp({
                        shiftTime: r
            ...
            v = function (t) {
                ...
                return (0, a.default)(e, t), e.prototype._declareDefaults = function () {
                    ...
                    for (var e = (0, p.default)(t), r = 0; r < e.length; r++) {
                        var i = e[r],
                            n = !this._drawExclude[i] && null == this._defaults[i] && !y[i],
        ...
        t.exports = !p || r(23)(function () {
            ...
            for (var r = o(t), p = arguments.length, u = 1, l = s.f, h = n.f; p > u;)
                for (var c, f = a(arguments[u++]), d = l ? i(f).concat(l(f)) : i(f), _ = d.length, y = 0; _ > y;) h.call(f, c = d[y++]) && (r[c] = f[c]);
            return r
        } : p
    }, function (t, e, r) {
        "use strict";
